...
ADOBE.AM.hierarchy_tree =function (){this.treeElement ="";this.folderSrc ="";this.listSrc =[];this.inc3rdParty =false;this.foldersOnly =false;this.folderThemeSrc ="";this.showCheckboxes =true;this.two_state =false;this.dots =false;this.icons =true;this.initially_select =[];this.initially_open =[];this.formatData =function (data) {jQuery.each(data,function (i,item) {item.data =DEMDEX.UTILS.unescape(item.data);});};var extractId =function() {var regex =null;if (arguments[1] =="segment") {regex =new RegExp("(seg_)?\\d+_"+ "segment_row_","");}
    ...
    },"types":{"max_depth":-2,"max_children":-2,"valid_children":["drive","folder","destination","category"],"types":{"trait":{"valid_children":"none","icon":{"image":"https://a248.e.akamai.net/demdex.download.akamai.com/corp/images/tree/leaf.gif"}
    },"destination":{"valid_children":"none","icon":{"image":"https://a248.e.akamai.net/demdex.download.akamai.com/corp/images/tree/leaf.gif"}
    },"segment":{"valid_children":"none","icon":{"image":"https://a248.e.akamai.net/demdex.download.akamai.com/corp/images/tree/leaf.gif"}
    },"folder":{"valid_children":["segment","folder"],"icon":{"image":"https://a248.e.akamai.net/demdex.download.akamai.com/corp/images/tree/folder.gif"}
