...
var s_account="omniture.suiteall,omniture.scall";
...
s.linkInternalFilters="javascript:,omniture.com";
...
function s_doPlugins(s) {  
  s.prop18=s.getDaysSinceLastVisit('s_dslv');
  s.prop19=s.getVisitNum();
}
s.doPlugins=s_doPlugins;
s.loadModule("Survey");
s.Survey.suites="omniture.suiteall";
...
s.trackingServerSecure='smetrics.omniture.com';
